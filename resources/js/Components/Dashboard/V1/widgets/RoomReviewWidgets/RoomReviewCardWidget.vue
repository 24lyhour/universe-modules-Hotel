...
import { Star, MessageSquare, Heart, Eye, Pencil, BedDouble as RoomIcon, CheckCircle, XCircle, ThumbsUp, Trash2 } from 'lucide-vue-next';
...
import type { RoomReview } from '@hotel/types';
...
const emit = defineEmits<{
    (e: 'view', review: RoomReview): void;
    (e: 'toggleActive', review: RoomReview, isActive: boolean): void;
    (e: 'delete', review: RoomReview): void;
    (e: 'reply', review: RoomReview): void;
}>();
        ...
        <CardContent class="p-6">
            <div class="flex gap-4">
                ...
                <div class="flex-1 min-w-0 space-y-3">
                    ...
                    <!-- Room Badge -->
                    <div v-if="review.room" class="flex items-center gap-2">
                        <Badge variant="outline" class="bg-primary/5 text-primary border-primary/20 flex gap-1.5 hover:bg-primary/10 transition-colors">
                            <RoomIcon class="h-3 w-3" />
                            {{ review.room.name }}
                            <span v-if="review.room.hotel" class="text-muted-foreground">&middot; {{ review.room.hotel.name }}</span>
                        </Badge>
